<template>
  <div class="tag-manage">
    <div class="tag-header">
      ...
      <el-button type="primary" size="small" @click="openCreate" :disabled="tagStore.tags.length >= 20">
    ...
    <div class="tag-list" v-if="tagStore.tags.length > 0">
      <div class="tag-item" v-for="tag in tagStore.tags" :key="tag.tagId">
        ...
        <div class="tag-actions">
          <Icon class="icon-btn" icon="ep:edit" width="16" height="16" @click="openEdit(tag)" />
          <Icon class="icon-btn delete" icon="uiw:delete" width="14" height="14" @click="handleDelete(tag)" />
        </div>
      </div>
    </div>
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? $t('editTag') : $t('addTag')" width="380px" append-to-body>
      <div class="tag-form">
        <el-input v-model="tagForm.name" :placeholder="$t('tagName')" maxlength="20" />
        <div class="color-row">
