const en = {
    ...
    securitySectionDesc: 'Show email authentication results (SPF, DKIM, DMARC) in email view',
    spf: 'SPF',
    dkim: 'DKIM',
    dmarc: 'DMARC',
    authPass: 'Pass',
    authFail: 'Fail',
    authSoftfail: 'Soft Fail',
    authNeutral: 'Neutral',
    authNone: 'None',
    authError: 'Error',
    renderMode: 'Rendering Mode',
    renderModeDesc: 'Default rendering mode for new emails',
    renderAllowAll: 'Allow All',
    renderAllowBasic: 'Allow Basic',
    renderDisallow: 'Disallow',
    renderAllowAllDesc: 'Fully render HTML with JavaScript and external resources',
    renderAllowBasicDesc: 'Render HTML safely, block scripts and trackers',
    renderDisallowDesc: 'Plain text only, block all HTML and external resources',
    contentBlocked: 'Some content has been blocked by security restrictions',
    contentBlockedDetail: '{count} item(s) blocked',
}
