const zh = {
    ...
    security: '安全',
    securitySection: '安全信息',
    securitySectionDesc: '在邮件详情中显示邮件认证结果（SPF、DKIM、DMARC）',
    spf: 'SPF',
    dkim: 'DKIM',
    dmarc: 'DMARC',
    authPass: '通过',
    ...
    authError: '错误',
    renderMode: '渲染模式',
    renderModeDesc: '新邮件的默认渲染模式',
    renderAllowAll: '允许全部',
    renderAllowBasic: '基本允许',
    renderDisallow: '禁止渲染',
    renderAllowAllDesc: '完全渲染 HTML，包括 JavaScript 和外部资源',
    renderAllowBasicDesc: '安全渲染 HTML，阻止脚本和追踪器',
    renderDisallowDesc: '仅纯文本，阻止所有 HTML 和外部资源',
    contentBlocked: '部分内容已被安全限制阻止',
    contentBlockedDetail: '已阻止 {count} 项',
}
export default zh
